...
void FShaderDirectoryModule::StartupModule()
{
	...
	const FString ShaderDirectory = FPaths::Combine(FPaths::ProjectPluginsDir(), TEXT("ShaderDirectory/Shaders"));
	AddShaderSourceDirectoryMapping("/Plugin/ShaderDirectory", ShaderDirectory);
}
